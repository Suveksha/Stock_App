...
export default function Dashboard() {
  ...
  const buttonStyle = {
    background:
      "linear-gradient(135deg, #06402B 0%, #0a6b45 100%)",
    color: "white",
    ...
    ":hover": {
      ...
      background:
        "linear-gradient(135deg, #0a6b45 0%, #0d8b56 100%)",
    },
  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center backgroundEffect px-6">
      ...
      >
        ...
        >
          Empowering investors with real-time insights, analytics, and data-driven tools to grow confidently in India’s dynamic markets.
        </motion.p>
